 ...
 *
 * Lifted verbatim from src/renderer/constants/modalPriorities.ts as part of the
 * Layer 2.1 primitives lift. Priorities are shared between the Electron renderer
 * and the webFull bundle so modal stacking semantics stay identical across both
 * targets even as features port over.
 *
 * Priority Ranges:
