 ...
 *
 * Lifted from src/renderer/hooks/ui/useLayerStack.ts as part of the Layer 2.1
 * primitives lift. Implementation is verbatim except for the relative import
 * path to the layer types module (which lives at src/webFull/types/layer.ts
 * in this tree).
 */
