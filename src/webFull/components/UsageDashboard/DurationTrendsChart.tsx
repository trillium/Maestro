/**
 * DurationTrendsChart — Usage Dashboard
 *
 * Lifted from src/renderer/components/UsageDashboard/DurationTrendsChart.tsx
 ...
 *   - `StatsTimeRange` / `StatsAggregation`: `'../../hooks/stats/useStats'` → `'./types'`
 *   - `COLORBLIND_LINE_COLORS`:      path string identical, resolves to the
