/**
 * SourceDistributionChart — Usage Dashboard
 *
 * Lifted from src/renderer/components/UsageDashboard/SourceDistributionChart.tsx
 ...
 *   - `COLORBLIND_BINARY_PALETTE`: path string identical, resolves to the
