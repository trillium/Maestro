...
- [ ] ISC-44.global.settings_broadcast: ISC-14 (PENDING) — `settings:changed` WS broadcast on server-side mutation so concurrent browsers stay in sync without reload. Currently MISSING. **Address in W2 server-side closures wave.**
